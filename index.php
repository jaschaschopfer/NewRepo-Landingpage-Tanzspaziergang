...
<header>
  ...
  <section class="newsletter-section animated-text-section" id="top">
    ...
    <div class="credentials-box">
      <form class="newsletter-form">
        ...
        <p class="acknowledge">Mit Klick auf "Anmelden" stimmst du der <a href="privacy.html" rel="noopener noreferrer">Datenschutzerklärung</a> zu.</p>
  ...
  <section class="info-section right-section animated-text-section right-aligned flex-grid">
    <div>
      ...
      <p>Anreise mit ÖV empfohlen</p>
      <p>Wenige Parkplätze nur beim Pflegeheim Utzigen</p>
    </div>
    <div>
      <h2>Wann?</h2>
      <p>Mai bis September</p>
      <p>Nur bei schönem Wetter</p> 
      <p>Zu-/Absagen am Vorstellungstag um 12 Uhr</p>
    </div>
    <div>
      <h2>Weiteres</h2>
      <p>Keine Anmeldung nötig</p>
      <p>Kollekte</p>
      <p>Nicht rollstuhlgängig</p>
      <p>Versicherung ist Sache der Teilnehmenden</p>
    </div>
  </section>
  ...
  <section class="newsletter-section animated-text-section" id="bottom">
  ...
  <footer>
    ...
    <div class="social-media">
      <a href="https://www.instagram.com/your-profile" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Instagram">
